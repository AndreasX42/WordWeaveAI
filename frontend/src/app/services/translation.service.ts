    ...
    const translations = {
      en: {
        ...
        wordCard: {
          ...
          notFound: 'The requested word could not be found.',
          ...
          noExamples: 'No examples available for this word.',
          ...
          conjugationData: {
            ...
            tenses: {
              presente: 'Present',
              preterito_perfecto_simple: 'Preterite',
              preterito_imperfecto: 'Imperfect',
              preterito_perfecto_compuesto: 'Present Perfect',
              preterito_pluscuamperfecto: 'Past Perfect',
              futuro: 'Future',
              futuro_perfecto: 'Future Perfect',
              condicional: 'Conditional',
              condicional_perfecto: 'Conditional Perfect',
            },
            pronouns: {
              yo: 'I',
              tu: 'you (informal)',
              ...
              vosotros_vosotras: 'you all (informal)',
              ellos_ellas_ustedes: 'they/you all (formal)',
            },
          },
        },
      },
      de: {
        ...
        wordCard: {
          ...
          errorTitle: 'Wort nicht gefunden',
          notFound: 'Das gesuchte Wort konnte nicht gefunden werden.',
          loadError: 'Fehler beim Laden. Bitte erneut versuchen.',
          ...
          synonyms: 'Synonyme',
          definition: 'Definition',
          noExamples: 'Keine Beispiele für dieses Wort verfügbar.',
          ...
          conjugationData: {
            ...
            tenses: {
              presente: 'Präsens',
              preterito_perfecto_simple: 'Präteritum',
              preterito_imperfecto: 'Imperfekt',
              preterito_perfecto_compuesto: 'Perfekt',
              preterito_pluscuamperfecto: 'Plusquamperfekt',
              futuro: 'Futur I',
              futuro_perfecto: 'Futur II',
              condicional: 'Konditional I',
              condicional_perfecto: 'Konditional II',
            },
            pronouns: {
              yo: 'ich',
              tu: 'du',
              el_ella_usted: 'er/sie/Sie',
              nosotros_nosotras: 'wir',
              vosotros_vosotras: 'ihr',
              ellos_ellas_ustedes: 'sie/Sie',
            },
          },
        },
      },
      es: {
        ...
        wordCard: {
          ...
          errorTitle: 'Palabra no encontrada',
          notFound: 'No se pudo encontrar la palabra solicitada.',
          loadError: 'Error al cargar. Por favor intenta de nuevo.',
          ...
          noExamples: 'No hay ejemplos disponibles para esta palabra.',
          clickToPlay: 'Clic para escuchar',
